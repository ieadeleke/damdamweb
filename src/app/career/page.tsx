            ...
            <div className="px-20 p0">
                <div className="flex gap-0 p-0 max-w-[1630px] mx-auto">
                    <div className="w-[500px]">
                        <Image src={CareerImg} alt="mail" quality={100} width={100} height={100} className="h-full w-auto" />
                    </div>
                    <div className="flex-1 text-right py-20">
                        ...
                        <h2 className="text-8xl leading-[1.2] text-white font-camptonbold">
                            Your Tech <br /> Career Starts <br /> Here +
                        </h2>
                    </div>
                </div>
                <Image src={HeroImg} alt="mail" quality={100} width={100} height={100} className="max-w-[1630px] mx-auto h-full w-full rounded-[20px] object-fit object-cover" />
                <div className="mt-20 max-w-[1630px] mx-auto">
