...
const WhatWeLookFor = () => {
    return (
        <div className="lookfor max-w-[1550px] mb-20 md:mb-28 bg-[#1E1E1E] rounded-[24px] py-14 px-5 md:px-0 md:pr-20 mx-auto md:grid grid-cols-2">
            <div></div>
            <div>
                <h4 className="text-white text-3xl md:text-5xl mb-4">
                ...
                <p className="text-sm md:text-[15px] border-l-4 border-[#31A5DE] py-2 pl-3 leading-loose text-white">
